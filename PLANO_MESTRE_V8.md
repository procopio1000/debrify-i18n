# Plano Mestre V8 — Internacionalização (i18n/l10n) completa do Debrify

**Status:** versão consolidada, oitava auditoria extrema, implementation-ready, toolchain-verified, packaging-verified-by-design, cross-runtime-verified, cross-device-semantic-verified, unicode/composition-hardened, canonical-gate-registry e baseline-drift-hardened  
...
# 0. Resultado das reauditorias V1 → V2 → V3 → V4 → V5 → V6 → V7 → V8
...
- documentos normativos usam gate IDs diferentes do registro V8.
...
A V8 adiciona uma condição temporal: cobertura só é atribuída ao SHA/tree registrado no manifest. Se a base upstream muda, a afirmação de completude expira até Gate Q revalidar o delta.
...
A meta da V8 é transformar “100%” de uma promessa subjetiva em um conjunto auditável de provas reproduzíveis que cobre source code, plataformas nativas, assets de runtime, copy oficial remota, app-supplied system UI, build-generated product copy, testes e o conteúdo efetivamente presente nos artifacts publicados.
