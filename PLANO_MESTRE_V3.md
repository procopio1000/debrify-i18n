# Plano Mestre V3 — Internacionalização (i18n/l10n) completa do Debrify

**Status:** versão consolidada, terceira auditoria extrema, implementation-ready e toolchain-verified  
...
# 0. Resultado das reauditorias V1 → V2 → V3
...
O V2 corrigiu o truncamento estrutural do V1. A V3 preserva V1 e V2 como histórico e passa a ser a especificação canônica, incorporando uma auditoria adicional do toolchain Flutter 3.44.8, do runtime realmente empacotado e de componentes nativos que funcionam sem o Flutter ativo.
...
1. PR A — dependency preflight (intl 0.20.2) + foundation + tests + ShippingLocales en-only + inventory contracts.
...
A meta da V3 é transformar “100%” de uma promessa subjetiva em um conjunto auditável de provas reproduzíveis.
